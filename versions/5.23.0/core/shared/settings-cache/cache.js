...
// 在这里保持 require 绝对最小是很重要的，
// 由于此缓存用于许多其他领域，我们可能会开放自己
// 循环依赖错误。
 ...
 */
/**
  * 为什么还没有将其移至@tryghost/settings-cache？
  *
  * - 它目前仍然通过事件系统以一种奇怪的方式将前端和服务器耦合在一起
  * - 请参阅 core/server/lib/common/events 中的注释
  * - 还有计划引入适当的缓存层，并在此之上重写它
  */
class CacheManager {
    /**
     * @prop {Object} options
